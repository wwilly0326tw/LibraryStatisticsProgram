...
if __name__ == '__main__':
    main(sfxFileName="../../Data/SFX/testsfx.xlsx", themeFileName="../../Data/SFX/testtheme.xlsx", year="2017")
    # main(sfxFileName="../../Data/SFX/1060421SFX_adv_both_both(上傳SFX範例).xlsx", themeFileName="../../Data/SFX/1060501主題院系表_ERMG(上傳主題範例).xlsx", year="2017")