...
from writeSFXtoDB import writeSFX2DB
from ParseDate.parseDate import extractInterval
from ISBNTransfer.ISBNTransfer import ISBN10to13
from writeDepartment import writeDepartment
from relateSFXDepart import relate_SFX_Depart
from relateThemeDepart import relate_Theme_Department
from ClassifyCategory.classifyCategory import classify
...
def main(sfxFileName="", themeFileName="", year="",  departFileName=""):
    if len(sys.argv) > 1:
...
if __name__ == '__main__':
    # main(sfxFileName="./testdata.xlsx", themeFileName="./1051219sfx主題分類-學院系所對照.xlsx", year="2016")
    main()